    ...
    <div className="flex-col h-full w-[30%] bg-white items-center justify-center border-gray-400 border-l-[1px]">
      ...
      <div>
        <div className="flex w-full items-center justify-end p-1 mt-3 pr-0">
          <button
            className="text-gray-900 bg-white mt-2 p-1 pb-3 pr-3 w-full text-right hover:border-white active:border-white "
          ...
          {props.state === "profileInfo" && (
            <span className="bg-gray-900 h-[40px] w-[14px] pr-0 text-gray-900 rounded-tl-lg rounded-bl-lg p-0" />
          )}
        </div>

        <div className="flex w-full items-center justify-end p-1 mt-3 pr-0">
          <button
            className="text-gray-900 bg-white p-1 pb-3 pr-3 w-full text-right hover:border-white "
          ...
          {props.state === "gallery" && (
            <span className="bg-gray-900 h-[40px] w-[14px] pr-0 text-gray-900 rounded-tl-lg rounded-bl-lg p-0"></span>
          )}
        </div>
